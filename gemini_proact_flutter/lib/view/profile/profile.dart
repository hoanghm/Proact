...
import 'package:gemini_proact_flutter/model/database/firestore.dart' show getUser, updateUser;
          ...
          children: [
            Row(
              ...
              children: [
                ...
                IconButton(
                  icon: const Icon(Icons.edit),
                  onPressed: () => _editInterests(interests),
                ),
              ],
            ),
            const SizedBox(height: 8),
        ...
        return AlertDialog(
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    // TODO: Implement adding a new interest
                  },
                ),
              ],
            ),
          ...
          actions: [
            ...
            TextButton(
              child: const Text('Save'),
              onPressed: () {
                // TODO: Implement updating the user's interests
                Navigator.of(context).pop();
                setState(() {
                  userFuture = _fetchUser(); // Refresh the user data
                });
