...
class BaseMission():
    ...
    '''
    title: str 
    id: str = field(factory=generate_firestore_id) # same format as firestore auto-generated ids
    ...
    steps: List['BaseMission'] = field(default=[])
    status: Type[MissionStatus] = field(default=MissionStatus.NOT_STARTED)
    deadline: Union[str, None] = field(default=None)
    styleId: Union[str, None] = field(default=None)
    ecoPoints: int = field(default=0)
    CO2InKg: int = field(default=0) 
    eventId: Union[str, None] = field(default=None)
    regenerationLeft: int = field(default=0)
    createdTimestamp: Union[str, None] = field(default=None)
